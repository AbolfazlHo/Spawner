...
- `Vector2 _spawnableSize`
  - Base size of each spawnable object.
- `Vector2 _padding`
  - Additional space added between each cell.
- `int _rowsCount`
  - Number of rows. -1 for automatic calculation.
- `int _columnsCount`
  - Number of columns. -1 for automatic calculation.
